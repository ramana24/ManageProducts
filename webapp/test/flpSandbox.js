						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ManageProducts-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"ManageProducts-display": {
								"semanticObject": "ManageProducts",
								"action": "display",
								"description": "Customer,Supplier,Product Details comparison",
								"title": "Manage Products",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ux.viewproducts",
									"url": sap.ui.require.toUrl("ux/viewproducts")
								}
							}
						}
					}
